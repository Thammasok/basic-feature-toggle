...
app.get('/dashboard', async (req, res) => {
  try {
    ...
    const response = await fetch(
      `http://localhost:${PORT}/api/feature-toggle/features/new_dashboard/check`,
      {
        method: 'POST',
        headers: {
...
app.listen(PORT, () => {
  ...
  console.log(
    `curl -X POST http://localhost:${PORT}/api/feature-toggle/features/new_dashboard/check \\`
  )
  ...
  console.log('')
  console.log(
    `curl -X PUT http://localhost:${PORT}/api/feature-toggle/features/new_dashboard/rollout \\`
  )
  console.log('  -H "Content-Type: application/json" \\')
